...
\because lim_{\epsilon \rightarrow 0}\frac{(3)}{\epsilon}\\
...
= E_p[(Y-(1,A,W))\beta(1,A,W)^TS(O)].........(5)\\
On\ the\ other\ hand, (4) = E_{P}((1,A,W)\beta)(1, A, W)^T - E_{P_\epsilon}((1,A,W)\beta)(1, A, W)^T\\
\\\ lim_{\epsilon \rightarrow 0}\frac{(4)}{\epsilon}\\
=
$$
