...
$$ \Psi(P_{\epsilon}) - \Psi(P) = E_{P_{\epsilon}}[(1,1,W)\beta_{\epsilon}]- E_{P}[(1,1,W)\beta]$$
$$= E_{P}[(1,1,W)(\beta_{\epsilon}-\beta)]+E_{P_{\epsilon}}[(1,1,W)\beta_{\epsilon}] -  E_{P}[(1,1,W)\beta_{\epsilon}]$$
$$=E_P[(1,1,W)(\beta_{\epsilon}-\beta)] + \int(1,1,W)\beta_{\epsilon}(1+\epsilon s(o))p(o)d_{\nu}(o) - \int(1,1,W)\beta_{\epsilon}p(o)d_{\nu}(o)$$
Next, we divide by $\epsilon$ and take the limit $\epsilon \rightarrow 0$ we get, upon setting $\text{lim}_{\epsilon \rightarrow 0}\frac{\beta_{\epsilon}-\beta}{\epsilon}=E_P[D_{\beta}(P)(O)S(O)]=<D_{\beta}(P)(O),S(O)>_P$ 

$$= $$



$$\frac{d}{d\epsilon}\Psi^1(P_\epsilon)|_{\epsilon=0}=\frac{d}{d\epsilon}\Big[\text{argmin}_{\gamma}E_{P_{\epsilon}}(Y - (1,A,W)\gamma)^2\Big]|_{\epsilon=0}=0_{d \times1}$$
